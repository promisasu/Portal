 ...
 */
function calculatePRFatigue (surveyResults) {
    let singleSurveyBlock = {};
    let instanceId = '';
    let resultSet = [];
 ...
 */
function calculatePRAnxiety (surveyResults) {
    let singleSurveyBlock = {};
    let instanceId = '';
    let resultSet = [];
 ...
 */
function calculatePRPhyFuncMob (surveyResults) {
    let singleSurveyBlock = {};
    let instanceId = '';
    let resultSet = [];
 ...
 */
function calculatePRPainInt (surveyResults) {
    let singleSurveyBlock = {};
    let instanceId = '';
    let resultSet = [];
...
/**
 * A helper function that calculates opioid score .
...
function opioidThresholdCalculation (opioidResults) {
    ...
    for (let i = 0; i < opioidResults.length; i++) {
        returnArr.push(70);
    }
...
/**
 * A helper function that checks if a value is a number
...
module.exports = {
    ...
    calculatePRFatigue: calculatePRFatigue,
    calculatePRAnxiety: calculatePRAnxiety,
    calculatePRPhyFuncMob: calculatePRPhyFuncMob,
    opioidResultsCalculation: opioidResultsCalculation,
    opioidThresholdCalculation: opioidThresholdCalculation,
    calculatePRPainInt: calculatePRPainInt
};
